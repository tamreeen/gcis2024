...
This is part 2, part 3 of the main program where the user enters the text file 
...
def pixels(turta):
    ...
    for line in range(ROWS):
        ...
        row_colors = "020202020202020202020"
         # Ziad: this is the string that holds the colors from get colors
