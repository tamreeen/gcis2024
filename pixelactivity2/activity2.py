...
def main():
    # Ask the user for the file name and path
    filename = input("Enter the file name: ")  # e.g: 'drawing01.txt'
    screen = Screen()  # Set up the screen
    turta = Turtle()  # Create a turtle object

    initialization(turta)  # Set initial turtle position
    picturefromfile(turta, filename)  # Draw the grid from the user-provided file
